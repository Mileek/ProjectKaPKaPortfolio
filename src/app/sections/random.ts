...
// ngOnInit(): void {
//   const textureURL: string = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/17271/lroc_color_poles_1k.jpg";
//   const displacementURL: string = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/17271/ldem_3_8bit.jpg";
...
//   const material: THREE.MeshPhongMaterial = new THREE.MeshPhongMaterial({ color: 0xffffff, map: texture, displacementMap: displacementMap, displacementScale: 0.02, bumpMap: displacementMap, bumpScale: 0.04, reflectivity: 0.1, shininess: 0 });
...
//   const worldMaterial: THREE.MeshBasicMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, map: worldTexture, side: THREE.BackSide });
