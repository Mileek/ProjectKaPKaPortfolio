...
import { faAngleDown, faAngleUp, faAnglesUp, faAngleLeft, faAngleRight } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule
{
  ...
  {
    library.addIcons(faAngleDown, faAngleUp, faAnglesUp, faAngleLeft, faAngleRight);
  }
}
